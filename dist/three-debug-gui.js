...
var i = (r, e, t) => p(r, typeof e != "symbol" ? e + "" : e, t);
import { Pane as d } from "tweakpane";
import { FrontSide as u, BackSide as f, DoubleSide as m, RepeatWrapping as w, ClampToEdgeWrapping as g, MirroredRepeatWrapping as b, Raycaster as x, Vector2 as v } from "three";
import { OrbitControls as P } from "three/addons/controls/OrbitControls";
import { TransformControls as S } from "three/addons/controls/TransformControls";
class T {
  constructor(e) {
    i(this, "context");
    i(this, "panel");
  ...
  parseObject(e) {
    var t;
    if (this.panel.addBinding(e, "type"), "isLight" in e && this.showLightProps(e), "material" in e) {
      const { material: n } = e, o = Array.isArray(n) ? n : [n];
      for (const [s, a] of o.entries())
        this.showMaterialProps(e, a, s);
    }
    "position" in e && this.showTransformProps(e), e.children.length && this.showGroupProps(e), (t = this.customHandler) == null || t.call(this, e, this.panel);
  }
  showLightProps(e) {
  ...
  showMaterialProps(e, t, n) {
    const o = n > 0 ? `Material${n}` : "Material", s = this.panel.addFolder({ title: o });
    s.addBinding(t, "type"), s.addBinding(e, "visible"), this.handleColor(s, t, "color"), this.handleColor(s, t, "emissive"), this.handleColor(s, t, "specular"), s.addBinding(t, "transparent"), s.addBinding(t, "opacity", { min: 0, max: 1 }), s.addBinding(t, "side", {
      options: {
        FrontSide: u,
        BackSide: f,
        DoubleSide: m
      ...
      t.side = a.value;
    }), "wireframe" in t && s.addBinding(t, "wireframe"), this.showMaterialTextureProps(s, t);
  }
  ...
  showMaterialTextureProps(e, t) {
    ...
    o.addBinding(n, "flipY"), o.addBinding(n, "rotation", { min: 0, max: Math.PI * 2, step: 0.01 }), o.addBinding(n.offset, "x", { label: "offsetX", min: 0, max: 1, step: 0.01 }), o.addBinding(n.offset, "y", { label: "offsetY", min: 0, max: 1, step: 0.01 }), o.addBinding(n.repeat, "x", { label: "repeatX" }), o.addBinding(n.repeat, "y", { label: "repeatY" }), o.addBinding(n, "wrapS", {
      label: "wrap",
      options: {
        RepeatWrapping: w,
      ...
      n.wrapS = a.value, n.wrapT = a.value, n.needsUpdate = !0;
    });
  }
  ...
  showTransformProps(e) {
    const t = {
      format: (o) => o.toFixed(2)
    }, n = this.panel.addFolder({ title: "Transform" });
    n.addBinding(e, "position", t), n.addBinding(e, "rotation", t), n.addBinding(e, "scale", t);
  }
  handleColor(e, t, n) {
    if (!t[n])
      return;
    const o = t[n], s = { [n]: o.getHex() };
    e.addBinding(s, n, { view: "color" }).on("change", (a) => {
      o.set(a.value);
    });
  }
...
class B {
  ...
  init() {
    var e;
    this.panel = new d({ title: this.title }), (e = this.panel.element.parentElement) == null || e.setAttribute("id", "scene-panel"), this.lightsFolder = this.panel.addFolder({ title: "Lights" });
  ...
  traverseScene(e, t) {
    ...
    if (this.exclude.includes(n))
      return;
    const s = (e.isLight ? this.lightsFolder : t).addFolder({ title: n });
    s.controller.view.buttonElement.removeEventListener(
      "click",
      s.controller.onTitleClick_
    ), s.controller.view.buttonElement.children[1].addEventListener(
      "click",
      s.controller.onTitleClick_
    ), s.controller.view.titleElement.addEventListener("click", (a) => {
      var h, l;
      a.preventDefault(), (l = (h = this.context).onSceneAction) == null || l.call(h, e);
    }), (this.keepClosed.includes(n) || e.isLight || e.isMesh) && (s.expanded = !1);
    for (const a of e.children)
      this.traverseScene(a, s);
  }
  toggle(e) {
...
class E {
  ...
  bindEvents(e) {
    this.controls.addEventListener("mouseUp", () => {
      var s, a;
      (a = (s = this.context).onTransformAction) == null || a.call(s, this.controls.object);
    }), this.controls.addEventListener("dragging-changed", (s) => {
      e != null && e.controls && (e.controls.enabled = !s.value);
  ...
  handleClick(e) {
    var n, o, s;
    if (!((n = this.controls) != null && n.enabled) || !this.isShiftPressed)
      return;
    ...
    t != null && t.object && (this.controls.attach(t.object), (s = (o = this.context).onTransformAction) == null || s.call(o, t.object));
  }
  toggle(e) {
...
class k {
  ...
  init({ scene: e, canvas: t, camera: n, options: o = {} }) {
    var s, a, h;
    if (!this.panel) {
      this.scene = e, this.canvas = t, this.camera = n, this.options = { ...this.options, ...o }, this.panel = new d({ title: "Debug" }), (s = this.panel.element.parentElement) == null || s.setAttribute("id", "debug-panel"), console.log(this.panel), this.components = {
        props: new T(this),
        orbit: new y(this),
        scene: new B(this),
        transform: new E(this)
      };
      for (const l of Object.keys(this.options))
        this.createToggle(l), this.options[l] && ((h = (a = this.components[l]).init) == null || h.call(a));
      this.enabled = !0;
    }
  }
  createToggle(e) {
    this.panel.addBinding(this.options, e).on("change", (t) => {
      var n;
      typeof t.value > "u" || (this.options[e] = t.value, (n = this.components[e]) == null || n.toggle(t.value));
    });
  }
  registerComponent({ label: e, instance: t, initialValue: n = !1 }) {
    ...
    this.options[e] = n, this.components[e] = t, this.createToggle(e), n === !0 && ((o = t.init) == null || o.call(t));
  }
  onSceneAction(e) {
    var t;
  ...
  onTransformAction(e) {
    this.components.props.init(e), this.components.props.panel.refresh(), this.logObject(e);
  }
  logObject(e) {
    e && (console.log(`
`), console.log("target:   ", e), console.log("position: ", e.position), console.log("rotation: ", e.rotation), console.log("scale:    ", e.scale));
  ...
  update(e) {
    var t, n, o, s;
    this.enabled && ((n = (t = this.components.orbit).update) == null || n.call(t, e), (s = (o = this.components.physics) == null ? void 0 : o.update) == null || s.call(o));
  }
}
const M = new k();
export {
